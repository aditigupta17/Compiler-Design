...
{
       0,   117,   117,   118,   120,   121,   125,   133,   124,   145,
     146,   149,   150,   153,   154,   157,   158,   161,   162,   163,
     164,   165,   166,   167,   168,   169,   170,   171,   174,   175,
     178,   179,   182,   188,   189,   195,   193,   209,   218,   221,
     227,   233,   238,   239,   240,   249,   257,   264,   275,   275,
     275,   288,   297,   310,   310,   310,   321,   322,   323,   326,
     327,   330,   331,   332,   335,   342,   345,   351,   361,   367,
     374,   381,   388,   395,   402,   412,   422,   430,   436,   441,
     449,   461,   473,   482,   494,   506,   514,   522,   530,   538,
     539,   542,   560,   561,   562,   563,   564,   565,   568,   576,
     584,   592,   600,   608,   616,   626,   633,   641,   642,   643,
     644,   647,   675,   676,   679,   687,   697,   698,   701,   706,
     713,   716
};
#endif
...
#line 617 "parser.y" /* yacc.c:1646  */
    {
						...
						string expr = (yyval.content)->addr + " = " + "minus " + (yyvsp[0].content)->addr;
...
#line 648 "parser.y" /* yacc.c:1646  */
    {
					if(is_declaration)
					{
						if((yyvsp[-1].entry)->value <= 0)
							yyerror("Illegal array size: only positive values should be assigned.\n");
...
void type_check(int left, int right, int flag)
{
	if(left != right)
	{
		switch(flag)
		{
			case 0: yyerror("Type mismatch in arithmetic expression"); 
				break;
			case 1: yyerror("Type mismatch in assignment expression");
				break;
			case 2: yyerror("Type mismatch in logical expression"); 
				break;
		}
	}
}
...
int main(int argc, char *argv[])
{
	...
	{
		printf("====================================================\n");
		printf("\tParsing completed successfully.\n Intermediate Code has been written to ICG.code file\n");
		printf("====================================================\n");
	}
	else
	{
